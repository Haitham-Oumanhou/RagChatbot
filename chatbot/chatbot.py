...
prompt = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    "You act as a Java teacher. Answer the user's question using exlusively the chat history and the pieces of the context :\n\n{context} ",
                ),
...
class RAG():
    ...
    def handle_user_input(self, user_input):
        changed_input = f"[INST] {user_input} [/INST]" 
